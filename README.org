...
Current Emacs version: /whatever/
...
** Colors
As written in [[https://github.com/ivalentinee/emacs_config/blob/master/.emacs.d/settings/setup-theme.el][this file]] there are 3 UI schemes.
...
=Light= scheme uses =adwaita= .

=Dark= scheme uses =tango-dark= for standalone emacs.

=Terminal= disables all themes to set emacs look "default".

Emacs starts with =dark= scheme.
