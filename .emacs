...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (haskell-mode haskell-snippets yasnippet-snippets cmake-mode disable-mouse magit helm helm-ag helm-projectile erlang typescript-mode flycheck alchemist company avy elixir-mode elixir-yasnippets ace-window ag aggressive-indent anzu autopair coffee-mode direx expand-region fill-column-indicator fireplace flatui-theme gitconfig-mode goto-last-change haml-mode highlight-parentheses ibuffer-vc js2-mode js2-refactor json-mode json-reformat json-snatcher less-css-mode lua-mode macro-math markdown-mode markdown-mode+ mo-git-blame multi-term multiple-cursors nginx-mode paredit php-mode projectile projectile-rails rails-log-mode rake restclient rspec-mode ruby-compilation ruby-end sass-mode scss-mode slim-mode slime smart-mode-line string-inflection urlenc web-mode yaml-mode yasnippet)))
