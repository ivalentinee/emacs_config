...
(add-to-list 'load-path "~/.emacs.d/settings/denote-graph")
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(denote-explore denote-org magit ace-window ag aggressive-indent anzu autopair avy cmake-mode company counsel denote direx disable-mouse elixir-mode elixir-yasnippets erlang expand-region fireplace flatui-theme flycheck gitconfig-mode helm-ag highlight-parentheses ibuffer-vc ivy jinja2-mode js2-mode json-mode json-reformat lsp-mode lua-mode macro-math markdown-mode markdown-mode+ multi-term multiple-cursors paredit password-generator pinentry prettier-js projectile rust-mode smart-mode-line string-inflection typescript-mode urlenc uuidgen vterm web-mode which-key yaml-mode))
 ...
 '(safe-local-variable-values
   '((denote-directory "~/.claude/flows/designs/")
     (eval lsp)
     (lsp-enabled-clients ts-ls eslint)
     (lsp-enabled-clients yamlls)
     (eval prettier-js-mode)
     (projectile-tags-command . "echo 'ripper-tags -R -e -f TAGS --exclude vendor/bundle && cat GEM_TAGS >> TAGS' | /bin/bash --login")
     (projectile-tags-command . "ctags-exuberant -Re --languages=ruby -f %s %s")))
