...
(custom-set-variables
 ...
 '(package-selected-packages
   '(which-key jinja2-mode ace-window ag aggressive-indent anzu autopair avy cmake-mode company direx disable-mouse elixir-mode elixir-yasnippets erlang expand-region fireplace flatui-theme flycheck gitconfig-mode helm-ag helm-lsp helm-projectile highlight-parentheses ibuffer-vc js2-mode json-mode json-reformat lsp-mode lua-mode macro-math magit markdown-mode markdown-mode+ multi-term multiple-cursors paredit password-generator pinentry prettier-js projectile rust-mode smart-mode-line string-inflection typescript-mode urlenc uuidgen vterm web-mode yaml-mode))
