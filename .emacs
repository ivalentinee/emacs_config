...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-window ag aggressive-indent anzu autopair avy cmake-mode company
                ...
                js2-mode json-mode json-reformat lsp-mode lua-mode
                macro-math magit markdown-mode markdown-mode+
                multi-term multiple-cursors paredit password-generator
                pinentry prettier-js projectile rust-mode
                smart-mode-line string-inflection typescript-mode
                urlenc uuidgen vterm web-mode which-key yaml-mode))
